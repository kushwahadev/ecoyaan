...
const LINKS = [
  ...
  },
  {
    ...
    items: [
      "1-N-12T-781/1 Sri Krishna Vilasa",
      "Urvastores",
      "Ashoknagar(MR)",
      "Mangalore",
  ...
  return (
    <footer className="relative w-full bg-slate-900 text-white">
      <div className="mx-auto w-full max-w-7xl px-8 text-white ">
        <div className="grid grid-cols-1 justify-between gap-0 md:grid-cols-2 text-white">
          <Typography variant="h5" className="mt-6 ">
            <h4
              className="col-span-2  text-lime-600 transition-all duration-500
           text-4xl font-extrabold"
            >
              Ecoyaan
            </h4>
          </Typography>
          <div className="grid grid-cols-4 justify-between gap-3 text-white mt-6">
        ...
        <div className="mt-12 text-white flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
